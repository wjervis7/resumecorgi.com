function Skeleton() {
  return (
    <div className="overflow-x-auto pb-4 animate-[pulse_5s_ease-in-out_infinite] brightness-85">
      <h2 className="sr-only">Your resume is rendering now. Please sit tight.</h2>
      <div className="mx-auto w-[800px] h-[1035px] p-10 shadow-md shadow-slate-800 dark:shadow-slate-600 bg-white">
