...
//   // Use width and height props or default values
//   const displayWidth = width || "100%";
//   const displayHeight = height || "auto";
  
//   return (  
//     <div className="w-full overflow-none animate-[pulse_5s_ease-in-out_infinite] brightness-85">
//       <h2 className="sr-only">Your resume is rendering now. Please sit tight.</h2>
//       <div
//         style={{
//           width: displayWidth,
//           height: displayHeight,
//           maxWidth: "800px", // Max width to prevent it from getting too large
